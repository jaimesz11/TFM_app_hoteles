    ...
    with c2:
        ...
        with st.beta_expander("Click para mostrar/ocultar el texto ⬇️"):
            ...
            <h2 style="line-height:150%; text-align:justify; font-size: 0.4cm;">
                ...
                <a href="https://colab.research.google.com/drive/10s5mk87EZg4krZRYvX9e48hPgGs3z4c9?usp=sharing"><img src="https://cdn-images-1.medium.com/max/1200/1*Lad06lrjlU9UZgSTHUoyfA.png" 
                width=60" height="25"></a></p>
            ...
            html_modelo_pred_canc3 = """    
                ...
                <p><strong>Para más información acceder a: </strong><a href="https://colab.research.google.com/drive/10s5mk87EZg4krZRYvX9e48hPgGs3z4c9?usp=sharing"><img src="https://cdn-images-1.medium.com/max/1200/1*Lad06lrjlU9UZgSTHUoyfA.png" 
                width=60" height="25"></a></p>
                </div>
                """    
